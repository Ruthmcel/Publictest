view: bi_demo_sales_eps_tx_tp_transmit_queue {
  ...
  dimension: unique_key {
    ...
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_id} ||'@'|| ${tx_tp_transmit_queue_id} ||'@'|| ${bi_demo_sales.sold_flg} ||'@'|| ${bi_demo_sales.adjudicated_flg} ;; #ERXLPS-1649
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_number_of_rejects {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_number_of_rejects END ;;
    value_format: "#,##0"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_price {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_price END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_cost {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_cost END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_tax {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_tax END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_amount END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_copay {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_copay END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_upcharge {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_upcharge END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_compound_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_compound_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_incentive {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_incentive END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_prof_service_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_prof_service_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_submit_dispensing_fee {
    ...
    description: "Dispensing fee submitted to the third party. The calculation for dispensing fee submitted is: rxPrice (brand or generic) - baseCost - upCharge - compoundFee. This field is EPS only!!!"
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_submit_dispensing_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_other_amount_claimed_1 {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_other_amount_claimed_1 END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_price {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_price END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_cost {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_cost END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_tax {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_tax END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_amount END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_copay {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_copay END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_upcharge {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_upcharge END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_compound_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_compound_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_incentive_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_incentive_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_prof_service_fee {
    ...
    description: "Professional service returned from the third party. This field is EPS only!!!"
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_prof_service_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_received_dispensing_fee {
    ...
    description: "Professional service returned from the third party. This field is EPS only!!!"
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_received_dispensing_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_price {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_price END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_cost {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_cost END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_tax {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_tax END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_copay {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_copay END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_upcharge {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_upcharge END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_compound_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_compound_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_final_incentive_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_final_incentive_fee END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_canadian_total_fees_received {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_canadian_total_fees_received END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_tp_paid_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_tp_paid_amount END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_balance_due_from_tp {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_balance_due_from_tp END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_accum_deductible {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_accum_deductible END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_deductible_subtotal {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_deductible_subtotal END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_copay_subtotal {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_copay_subtotal END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_drug_select_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_drug_select_amount END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_exceed_benefit {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_exceed_benefit END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_tax_in_copay {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_tax_in_copay END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_flat_tax_amount_paid {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_flat_tax_amount_paid END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_remaining_benefit {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_remaining_benefit END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_remaining_deductible {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_remaining_deductible END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_other_amount_claimed_2 {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_other_amount_claimed_2 END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_other_amount_claimed_3 {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_other_amount_claimed_3 END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_other_payer_amt_recognized {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_other_payer_amt_recognized END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_num_downtime_attempts {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_num_downtime_attempts END ;;
    value_format: "#,##0"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_pct_tax_amount_paid {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_pct_tax_amount_paid END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_transmit_queue_pct_tax_rate_paid {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_transmit_queue_pct_tax_rate_paid END ;;
    value_format: "0.00\"%\""
  }
}
