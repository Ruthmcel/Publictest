view: sales_eps_tx_tp_resp_approval_message {
  ...
  dimension: primary_key {
    ...
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_response_approval_message_id} ||'@'|| ${sales.sold_flg} ||'@'|| ${sales.adjudicated_flg} ||'@'|| ${report_calendar_global.type} ;; #ERXLPS-1649
  }
