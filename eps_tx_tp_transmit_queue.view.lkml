view: eps_tx_tp_transmit_queue {
  ...
  dimension: unique_key {
    ...
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_id} ||'@'|| ${tx_tp_transmit_queue_id} ;; #ERXLPS-1649
  }
  ...
  dimension_group: tx_tp_transmit_queue_response_date {
  ...
  dimension_group: tx_tp_transmit_queue_original_submit_date {
  ...
  dimension_group: tx_tp_transmit_queue_fill_override_date {
  ...
  measure: tx_tp_transmit_queue_number_of_rejects {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_NUMBER_OF_REJECTS ;;
    value_format: "#,##0"
  }

  measure: tx_tp_transmit_queue_submit_price {
  ...
  measure: tx_tp_transmit_queue_submit_amount {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_AMOUNT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_copay {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_COPAY ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_upcharge {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_UPCHARGE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_compound_fee {
    label: "Transmit Queue Submit Compound Fee"
    description: "Compounding fee submitted to the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_COMPOUND_FEE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_incentive {
    label: "Transmit Queue Submit Incentive"
    description: "Incentive fee submitted to the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_INCENTIVE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_prof_service_fee {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_SUBMIT_PROF_SERVICE_FEE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_submit_dispensing_fee {
  ...
  measure: tx_tp_transmit_queue_other_amount_claimed_1 {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_OTHER_AMOUNT_CLAIMED_1 ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_price {
  ...
  measure: tx_tp_transmit_queue_received_cost {
    label: "Transmit Queue Received Cost"
    description: "Cost returned from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_COST ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_tax {
    label: "Transmit Queue Received Tax"
    description: "Tax returned from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_TAX ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_amount {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_AMOUNT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_copay {
    label: "Transmit Queue Received Copay"
    description: "Copay returned from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_COPAY ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_upcharge {
    label: "Transmit Queue Received Upcharge"
    description: "Upcharge returned from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_UPCHARGE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_compound_fee {
    label: "Transmit Queue Received Compound Fee"
    description: "Compound fee returned from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_COMPOUND_FEE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_incentive_fee {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_INCENTIVE_FEE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_prof_service_fee {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_RECEIVED_PROF_SERVICE_FEE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_received_dispensing_fee {
  ...
  measure: tx_tp_transmit_queue_canadian_total_fees_received {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_CANADIAN_TOTAL_FEES_RECEIVED ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_tp_paid_amount {
    label: "Transmit Queue TP Paid Amount"
    description: "Amount paid by the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_TP_PAID_AMOUNT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_balance_due_from_tp {
    label: "Transmit Queue Balance Due From TP"
    description: "Amount due from third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_BALANCE_DUE_FROM_TP ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_accum_deductible {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_ACCUM_DEDUCTIBLE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_deductible_subtotal {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_DEDUCTIBLE_SUBTOTAL ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_copay_subtotal {
    label: "Transmit Queue Copay Subtotal"
    description: "Copay sub-total received from the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_COPAY_SUBTOTAL ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_drug_select_amount {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_DRUG_SELECT_AMOUNT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_exceed_benefit {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_EXCEED_BENEFIT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_tax_in_copay {
    label: "Transmit Queue Tax In Copay"
    description: "Amount of tax included in the copay amount. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_TAX_IN_COPAY ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_flat_tax_amount_paid {
    label: "Transmit Queue Flat Tax Amount Paid"
    description: "Flat tax amount paid by the third party. This field is EPS only!!!"
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_FLAT_TAX_AMOUNT_PAID ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_remaining_benefit {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_REMAINING_BENEFIT ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_remaining_deductible {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_REMAINING_DEDUCTIBLE ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_other_amount_claimed_2 {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_OTHER_AMOUNT_CLAIMED_2 ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_other_amount_claimed_3 {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_OTHER_AMOUNT_CLAIMED_3 ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_other_payer_amt_recognized {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_OTHER_PAYER_AMT_RECOGNIZED ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_num_downtime_attempts {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_NUM_DOWNTIME_ATTEMPTS ;;
    value_format: "#,##0"
  }

  measure: tx_tp_transmit_queue_pct_tax_amount_paid {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_PCT_TAX_AMOUNT_PAID ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  measure: tx_tp_transmit_queue_pct_tax_rate_paid {
    ...
    type: sum
    sql: ${TABLE}.TX_TP_TRANSMIT_QUEUE_PCT_TAX_RATE_PAID ;;
    value_format: "0.00\"%\""
  }
  ...
  ####################################################################### Sets ###################################################################
  #[ERXLPS-652] This set is created only with dimensions. All the measures are directly created in Sales view.
  set: sales_tx_tp_transmit_queue_dimension_candidate_list {
    fields: [
      tx_tp_transmit_queue_reference_number,
      tx_tp_transmit_queue_response_text,
      tx_tp_transmit_queue_help_desk_phone,
      tx_tp_transmit_queue_pct_tax_dispense_basis_code,
      tx_tp_transmit_queue_product_qualifier,
      tx_tp_transmit_queue_claim_template_id,
      tx_tp_transmit_queue_intermediary_auth_id,
      tx_tp_transmit_queue_response_payer_id,
      tx_tp_transmit_queue_plan_transmit_bin_number,
      tx_tp_transmit_queue_plan_pcn_number,
      tx_tp_transmit_queue_procedure_modifier_code,
      tx_tp_transmit_queue_original_prescribed_ndc,
      tx_tp_transmit_queue_status,
      tx_tp_transmit_queue_paid_status,
      tx_tp_transmit_queue_claim_format_type,
      tx_tp_transmit_queue_alternate_protocol_flag,
      tx_tp_transmit_queue_duplicate_flag,
      tx_tp_transmit_queue_downtime_flag,
      tx_tp_transmit_queue_print_british_columbia_label,
      tx_tp_transmit_queue_other_amount_claimed_qual_1,
      tx_tp_transmit_queue_basis_of_paid_amount,
      tx_tp_transmit_queue_tax_recalc_flag,
      tx_tp_transmit_queue_change_date_flag,
      tx_tp_transmit_queue_fee_basis_code,
      tx_tp_transmit_queue_copay_basis_code,
      tx_tp_transmit_queue_flat_tax_basis_code,
      tx_tp_transmit_queue_pct_tax_amount_basis_code,
      tx_tp_transmit_queue_intermediary_auth_type,
      tx_tp_transmit_queue_other_amount_claimed_qual_2,
      tx_tp_transmit_queue_other_amount_claimed_qual_3,
      tx_tp_transmit_queue_how_processed,
      tx_tp_transmit_queue_response_payer_id_qual,
      tx_tp_transmit_queue_current_record,
      tx_tp_transmit_queue_change_billing_reversal_reject,
      tx_tp_transmit_queue_claim_override
    ]
  }
  ...
  set: explore_sales_specific_candidate_list {
    fields: [
      sum_sales_tx_tp_transmit_queue_number_of_rejects,
      sum_sales_tx_tp_transmit_queue_submit_price,
      sum_sales_tx_tp_transmit_queue_submit_cost,
      sum_sales_tx_tp_transmit_queue_submit_tax,
      sum_sales_tx_tp_transmit_queue_submit_amount,
      sum_sales_tx_tp_transmit_queue_submit_copay,
      sum_sales_tx_tp_transmit_queue_submit_upcharge,
      sum_sales_tx_tp_transmit_queue_submit_compound_fee,
      sum_sales_tx_tp_transmit_queue_submit_incentive,
      sum_sales_tx_tp_transmit_queue_submit_prof_service_fee,
      sum_sales_tx_tp_transmit_queue_submit_dispensing_fee,
      sum_sales_tx_tp_transmit_queue_other_amount_claimed_1,
      sum_sales_tx_tp_transmit_queue_received_price,
      sum_sales_tx_tp_transmit_queue_received_cost,
      sum_sales_tx_tp_transmit_queue_received_tax,
      sum_sales_tx_tp_transmit_queue_received_amount,
      sum_sales_tx_tp_transmit_queue_received_copay,
      sum_sales_tx_tp_transmit_queue_received_upcharge,
      sum_sales_tx_tp_transmit_queue_received_compound_fee,
      sum_sales_tx_tp_transmit_queue_received_incentive_fee,
      sum_sales_tx_tp_transmit_queue_received_prof_service_fee,
      sum_sales_tx_tp_transmit_queue_received_dispensing_fee,
      sum_sales_tx_tp_transmit_queue_final_price,
      sum_sales_tx_tp_transmit_queue_final_cost,
      sum_sales_tx_tp_transmit_queue_final_tax,
      sum_sales_tx_tp_transmit_queue_final_copay,
      sum_sales_tx_tp_transmit_queue_final_upcharge,
      sum_sales_tx_tp_transmit_queue_final_compound_fee,
      sum_sales_tx_tp_transmit_queue_final_incentive_fee,
      sum_sales_tx_tp_transmit_queue_canadian_total_fees_received,
      sum_sales_tx_tp_transmit_queue_tp_paid_amount,
      sum_sales_tx_tp_transmit_queue_balance_due_from_tp,
      sum_sales_tx_tp_transmit_queue_accum_deductible,
      sum_sales_tx_tp_transmit_queue_deductible_subtotal,
      sum_sales_tx_tp_transmit_queue_copay_subtotal,
      sum_sales_tx_tp_transmit_queue_drug_select_amount,
      sum_sales_tx_tp_transmit_queue_exceed_benefit,
      sum_sales_tx_tp_transmit_queue_tax_in_copay,
      sum_sales_tx_tp_transmit_queue_flat_tax_amount_paid,
      sum_sales_tx_tp_transmit_queue_remaining_benefit,
      sum_sales_tx_tp_transmit_queue_remaining_deductible,
      sum_sales_tx_tp_transmit_queue_other_amount_claimed_2,
      sum_sales_tx_tp_transmit_queue_other_amount_claimed_3,
      sum_sales_tx_tp_transmit_queue_other_payer_amt_recognized,
      sum_sales_tx_tp_transmit_queue_num_downtime_attempts,
      sum_sales_tx_tp_transmit_queue_pct_tax_amount_paid,
      sum_sales_tx_tp_transmit_queue_pct_tax_rate_paid
    ]
  }
}
