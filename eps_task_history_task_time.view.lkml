view: eps_task_history_task_time {
  ...
  measure: avg_task_time {
    ...
    description: "Average time taken for user to complete a task from the getnext to complete status. Value is displayed in Seconds. Calculation Used: Current Task Action Time - Previous Task Action Time, with respect to the most recent 'getnext' and 'completed' action for the same task within a given prescription transanction under a pharmacy chain"
    type: number
  ...
  measure: median_task_time {
    ...
    description: "Median time taken for user to complete a task from the getnext to complete status. Value is displayed in Seconds. Calculation Used: Current Task Action Time - Previous Task Action Time, with respect to the most recent 'getnext' and 'completed' action for the same task within a given prescription transanction under a pharmacy chain"
    type: number
  ...
  measure: max_task_time {
    ...
    description: "Maximum  time taken for user to complete a task from the getnext to complete status. Value is displayed in Seconds. Calculation Used: Current Task Action Time - Previous Task Action Time, with respect to the most recent 'getnext' and 'completed' action for the same task within a given prescription transanction under a pharmacy chain"
    type: number
  ...
  measure: min_task_time {
    ...
    description: "Minimum  time taken for user to complete a task from the getnext to complete status. Value is displayed in Seconds. Calculation Used: Current Task Action Time - Previous Task Action Time, with respect to the most recent 'getnext' and 'completed' action for the same task within a given prescription transanction under a pharmacy chain"
    type: number
    sql: MIN(${TABLE}.TASK_TIME) ;;
    value_format: "###0.00"
  }

  measure: sum_task_time {
    label: "Sum Task Time (In Seconds)"
    description: "Sum of the time taken for a user to complete a task from the getnext to complete status. Value is displayed in Seconds. Calculation Used: Current Task Action Time - Previous Task Action Time, with respect to the most recent 'getnext' and 'completed' action for the same task within a given prescription transanction under a pharmacy chain"
    type: number
    sql: SUM(${TABLE}.TASK_TIME) ;;
    value_format: "###0.00"
  }
}
