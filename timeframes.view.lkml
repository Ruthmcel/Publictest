view: timeframes {
  #[ERXLPS-1229] - Removed code for standard calendar and added all time components from d_fiscal_date table.
  derived_table: {
    sql: select chain_id calendar_owner_chain_id,
                ...
                fiscal_year year,
                case when fiscal_date.calendar_type = 'STANDARD' then fiscal_day_of_week - 1
                     else fiscal_day_of_week
                end week_index,
