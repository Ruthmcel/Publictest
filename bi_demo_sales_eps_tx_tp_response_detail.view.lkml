view: bi_demo_sales_eps_tx_tp_response_detail {
  # [ERXLPS-1020] - New view with sales_eps_tx_tp_response_detail created for eps_tx_tp_response_detail.
  ...
  # [ERXDWPS-7020] - Removed unused date dimension and measures created for other than sales explore. This view is specifically created for Sales Explore and not referenced in any other explores.
  ...
  dimension: unique_key {
    hidden: yes
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_response_detail_id} ||'@'|| ${bi_demo_sales.sold_flg} ||'@'|| ${bi_demo_sales.adjudicated_flg} ;; #ERXLPS-1649
  }
  ...
  dimension: tx_tp_response_detail_group_identifier_deidentified {
    ...
    sql: SHA2(${TABLE}.TX_TP_RESPONSE_DETAIL_GROUP_IDENTIFIER) ;;
  }
  ...
  #[ERXLPS-1436] - Deidentified dimension to use in DEMO Model
  dimension: tx_tp_response_detail_cardholder_identifier_deidentified {
    ...
    type: string
    # sha2 by default uses 256 as the message digest size.
    sql: SHA2(${TABLE}.TX_TP_RESPONSE_DETAIL_CARDHOLDER_IDENTIFIER) ;;
  }

  #[ERXLPS-1436] - Deidentified dimension to use in DEMO Model
  dimension: tx_tp_response_detail_medicaid_id_number_deidentified {
    ...
    type: string
    # sha2 by default uses 256 as the message digest size.
    sql: SHA2(${TABLE}.TX_TP_RESPONSE_DETAIL_MEDICAID_ID_NUMBER) ;;
  }

  #[ERXLPS-1436] - Deidentified dimension to use in DEMO Model
  dimension: tx_tp_response_detail_medicaid_agency_number_deidentified {
    ...
    type: string
    # sha2 by default uses 256 as the message digest size.
    sql: SHA2(${TABLE}.TX_TP_RESPONSE_DETAIL_MEDICAID_AGENCY_NUMBER) ;;
  }

  #[ERXDWPS-7020] - created dimension to reference in AWP Ingredient Cost % and WAC Ingredient Cost % dimensions and measures.
  dimension: sales_tx_tp_response_detail_ingredient_amount {
    ...
    type: number
    hidden: yes
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y') THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_INGREDIENT_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }

  #[ERXDWPS-7020] - Dispensing Fee Paid added as dimension.
  dimension: tx_tp_response_detail_dispensing_fee_paid {
  ...
  measure: sum_sales_tx_tp_response_detail_percent_sales_tax_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PERCENT_SALES_TAX_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_percent_sales_tax_rate {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PERCENT_SALES_TAX_RATE END ;;
    value_format: "00.00\"%\""
  }
  ...
  measure: sum_sales_tx_tp_response_detail_periodic_deductible_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PERIODIC_DEDUCTIBLE_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_copay_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_COPAY_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_coinsurance_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_COINSURANCE_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_exceed_period_benefit_maximum_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_EXCEED_PERIOD_BENEFIT_MAXIMUM_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_processor_amount_fee {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PROCESSOR_AMOUNT_FEE END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_tax_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_TAX_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_pns_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_PNS_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_ps_brand_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_PS_BRAND_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_ps_npfs_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_PS_NPFS_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_ps_bnpfs_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_PS_BNPFS_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_attributed_coverage_gap_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ATTRIBUTED_COVERAGE_GAP_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_hp_fund_assistance_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_HP_FUND_ASSISTANCE_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_patient_pay_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PATIENT_PAY_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_dispensing_fee_paid {
    ...
    description: "Dispensing fee paid included in the 'Total Amount Paid' (509-F9). This field is EPS only!!!"
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_DISPENSING_FEE_PAID END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_professional_service_fee_paid {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PROFESSIONAL_SERVICE_FEE_PAID END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_incentive_fee_paid_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_INCENTIVE_FEE_PAID_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_flat_sales_tax_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_FLAT_SALES_TAX_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_payer_recognized_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PAYER_RECOGNIZED_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_total_amount_paid {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_TOTAL_AMOUNT_PAID END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_patient_sales_tax {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PATIENT_SALES_TAX END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_plan_sales_tax {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_PLAN_SALES_TAX END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_accumulated_deductible_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ACCUMULATED_DEDUCTIBLE_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_remaining_deductible_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_REMAINING_DEDUCTIBLE_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_remaining_benefit_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_REMAINING_BENEFIT_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_estimated_generic_savings_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_ESTIMATED_GENERIC_SAVINGS_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
  ...
  measure: sum_sales_tx_tp_response_detail_spending_account_remaining_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.TX_TP_RESPONSE_DETAIL_SPENDING_ACCOUNT_REMAINING_AMOUNT END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
}
