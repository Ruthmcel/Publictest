view: bi_demo_sales_eps_tx_tp_response_preferred_product {
  ...
  dimension: primary_key {
    ...
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_response_preferred_product_id} ||'@'|| ${bi_demo_sales.sold_flg} ||'@'|| ${bi_demo_sales.adjudicated_flg}  ;; #ERXLPS-1649
  }
  ...
  measure: tx_tp_response_preferred_product_incentive_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_response_preferred_product_incentive_amount END ;;
  ...
  measure: tx_tp_resp_preferred_prod_cost_share_incentive_amount {
    ...
    type: sum
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg} = 'Y')  THEN ${TABLE}.tx_tp_resp_preferred_prod_cost_share_incentive_amount END ;;
    value_format: "$#,##0.00;($#,##0.00)"
  }
}
