view: sales_eps_shipment {
  ...
  dimension: unique_key {
    ...
    primary_key: yes
    type: string
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${shipment_id}||'@'|| ${sales.sold_flg} ||'@'|| ${sales.adjudicated_flg} ||'@'|| ${report_calendar_global.type} ;;
  }
...
#[ERXDWPS-6426] |Changed type from count to count_distinct because filter/parameter does not work with type: count
  measure: count {
