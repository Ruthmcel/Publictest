view: bi_demo_sales_rx_tx_transfer_prior_fill_dates {
  ...
  dimension: primary_key {
    ...
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${transfer_prior_fill_id} ||'@'|| ${bi_demo_sales.sold_flg} ||'@'|| ${bi_demo_sales.adjudicated_flg}  ;; #ERXLPS-1649
  }
  ...
  dimension: transfer_prior_fill_other_store_rx_number_deidentified {
    ...
    sql: SHA2(${TABLE}.TRANSFER_PRIOR_FILL_OTHER_STORE_RX_NUMBER) ;;
    value_format: "####"
  }
  ...
  measure: sum_transfer_prior_fill_quantity {
    ...
    sql: CASE WHEN (${bi_demo_sales.adjudicated_flg} = 'Y' or ${bi_demo_sales.sold_flg}= 'Y') THEN ${transfer_prior_fill_quantity} END ;;
    value_format: "#,##0.00"
  }
  ...
  set: explore_rx_store_transfer_prior_fill_4_10_candidate_list {
    fields: [
      transfer_prior_fill_other_store_rx_number_deidentified,
      transfer_prior_fill,
