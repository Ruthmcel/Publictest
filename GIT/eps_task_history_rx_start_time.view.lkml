view: eps_task_history_rx_start_time {
    ...
    sql: WITH RX_TX AS
          (SELECT R.CHAIN_ID
            ...
            WHERE R.RX_DELETED = 'N'
              ...
              AND {% if _explore._name == 'eps_workflow_order_entry_rx_tx' %}
                    {% condition eps_rx.rx_number %} R.RX_NUMBER {% endcondition %}
                  {% else %}
                    1 = 1
                  {% endif %}
