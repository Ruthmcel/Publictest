view: bi_demo_store_user {
  ...
  #[ERXLPS-2078] - Reference dimension to use in joins.
  dimension: store_user_login_reference {
  ...
  #[ERXDWPS-5731]
  dimension: store_user_employee_number_reference {
  ...
  dimension: store_user_employee_number {
    ...
    type: string
    description: "Employee ID assigned by customer human resources/personnel department or store. EPS Table Name: USERS"
    sql: SHA2(${TABLE}.USER_EMPLOYEE_NUMBER) ;;
  }
  ...
  dimension: store_user_first_name {
    ...
    sql: SHA2(${TABLE}.USER_FIRST_NAME) ;;
  }
  ...
  dimension: store_user_middle_name {
    ...
    sql: SHA2(${TABLE}.USER_MIDDLE_NAME) ;;
  }
  ...
  dimension: store_user_npi_number {
    ...
    sql: SHA2(${TABLE}.USER_NPI_NUMBER) ;;
  }
  ...
  measure: count {
    ...
    type: count
    value_format: "#,##0"
    drill_fields: [bi_demo_store_user_drill_path*]
  }

  ############################################# Sets #####################################################
  set: bi_demo_store_user_drill_path {
    fields: [
