view: sales_rx_tx_transfer {
  ...
  dimension: primary_key {
    ...
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${transfer_id} ||'@'|| ${sales.sold_flg} ||'@'|| ${sales.adjudicated_flg} ||'@'|| ${report_calendar_global.type}  ;; #ERXLPS-1649
  }
  ...
  dimension: transfer_pharmacy_name {
    ...
    sql: UPPER(${sales_rx_tx_transfer_pharmacy.pharmacy_name}) ;; #[ERXLPS-1961] Added upper function to display all Pharmacy names in UPPER.
  }
  ...
  dimension: transfer_pharmacy_address_line_1 {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_address.address_line_1} ;;
  }
  ...
  dimension: transfer_pharmacy_address_line_2 {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_address.address_line_2} ;;
  }
  ...
  dimension: transfer_pharmacy_address_city {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_address.address_city} ;;
  }
  ...
  dimension: transfer_pharmacy_address_state {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_address.address_state} ;;
  }
  ...
  dimension: transfer_pharmacy_address_postal_code {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_address.address_postal_code} ;;
  }
  ...
  dimension: transfer_pharmacy_phone_number {
    ...
    sql: ${sales_rx_tx_transfer_pharmacy_phone.phone_number} ;;
  }
  ...
  measure: count_transfer {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN ${transfer_id} END ;;
    value_format: "#,##0"
  }
  ...
  measure: count_outgoing {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_status_reference} = '0' THEN 1 ELSE 0 END) END ;; #[ERXLPS-1961]
    value_format: "#,##0"
  }
  ...
  measure: count_incoming {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_status_reference} = '1' THEN 1 ELSE 0 END) END ;; #[ERXLPS-1961]
    value_format: "#,##0"
  }
  ...
  measure: count_auto_transfer {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_type_reference} ='A' THEN 1 ELSE 0 END) END ;;
    value_format: "#,##0"
  }
  ...
  measure: count_manual_transfer {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_type_reference} ='S' THEN 1 ELSE 0 END) END ;;
    value_format: "#,##0"
  }
  ...
  measure: count_outgoing_single_refill {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY'
  ...
  measure: sum_transfer_outgoing_remaining_quantity {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_status_reference} = '0' THEN ${transfer_remaining_quantity} END) END ;;
    value_format: "#,##0.00"
  }
  ...
  measure: sum_transfer_incoming_remaining_quantity {
    ...
    sql: CASE WHEN (${sales.adjudicated_flg} = 'Y' or ${sales.sold_flg}= 'Y') AND ${report_calendar_global.type} = 'TY' THEN (CASE WHEN ${transfer_status_reference} = '1' THEN ${transfer_remaining_quantity} END) END ;;
    value_format: "#,##0.00"
  }
  ...
  set: explore_rx_store_transfer_4_10_candidate_list {
    fields: [
      ...
      transfer_pharmacy_name #[ERXLPS-1535]
    ]
  }
}
