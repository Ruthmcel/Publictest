view: eps_shipment {
  ...
  dimension: unique_key {
    hidden: yes
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${shipment_id} ;; #ERXLPS-1649
  }
  ...
  dimension_group: shipment_create {
    ...
    description: "Date/Time shipment record was created"
    type: time
    timeframes: [
      time,
      date,
  ...
  dimension_group: shipment_promised {
    ...
    description: "Date/Time shipment was promised"
    type: time
    timeframes: [
      time,
      date,
  ...
  dimension_group: shipment_date {
    label: "Shipment"
    description: "Date/Time that the shipment should be shipped by"
    type: time
    timeframes: [
      time,
      date,
  ...
  dimension: shipment_care_of {
    ...
    description: "Indicates the intermediary who is responsible for accepting the shipment"
    type: string
  ...
  dimension: shipment_created_by {
    ...
    description: "Indicates the name of the person that created the shipment"
    type: string
  ...
  dimension: shipment_ship_to {
    ...
    description: "Indicates the person or destination that the shipment is sent to"
    type: string
  ...
  dimension: shipment_shipper_name {
    ...
    description: "The name of the person or service that is delivering the shipment"
    type: string
  ...
  dimension: shipment_shipping_instructions {
    ...
    description: "Stores any special instructions for the delivery of the shipment"
    type: string
  ...
  dimension: shipment_shipping_method {
    ...
    description: "The method that is being used to send the shipment"
    type: string
  ...
  dimension: shipment_tracking_url {
    ...
    description: "The web URL used for tracking the shipment"
  ...
  dimension: shipment_refrigerated {
    ...
    description: "The Storage Temperature required for the shipment as specified by the User who initiated the shipment"
    type: string
  ...
  dimension: shipment_require_signature {
    ...
    description: "Yes / No Flag indicating if a signature is required when the shipment is picked up or delivered"
    type: yesno
  ...
  measure: sum_shipment_weight {
    ...
    description: "The weight of the shipment package"
    type: sum
  ...
  measure: sum_shipment_cost {
    ...
    description: "The cost of delivering the shipment"
    type: sum
