view: bi_demo_sales_eps_tx_tp_denial_clarification {
  ...
  dimension: primary_key {
    ...
    primary_key: yes
    sql: ${chain_id} ||'@'|| ${nhin_store_id} ||'@'|| ${tx_tp_denial_clarification_id}  ||'@'|| ${bi_demo_sales.sold_flg} ||'@'|| ${bi_demo_sales.adjudicated_flg} ;; #ERXLPS-1649
  }
